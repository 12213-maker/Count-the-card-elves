...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchForm: {
        ...
        keyword: "",
        dateTime: date,
        areaCode: sessionStorage.getItem("currentAreaCode")
          ? sessionStorage.getItem("currentAreaCode")
          : sessionStorage.getItem("areaId"),
        pageSize: 10,
        areaName: sessionStorage.getItem("currentAreaName")
          ? sessionStorage.getItem("currentAreaName")
  ...
  mounted() {
    ...
    if (localStorage.getItem("clearKeyword") === "false") {
      this.searchForm.keyword = localStorage.getItem(
        "keyword",
  ...
  methods: {
    ...
    dateChange(val) {
      ...
      const recommandList =
        this.$refs[`cardList${this.active}`][0].$refs.recommandList;

      if (
        !cardList.detailView &&
        (!recommandList || (recommandList && !recommandList.detailView))
      ) {
